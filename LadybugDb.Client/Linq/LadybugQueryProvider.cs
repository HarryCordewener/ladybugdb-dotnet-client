...
public sealed class LadybugQueryProvider : ILadybugAsyncQueryProvider
{
    ...
    /// <inheritdoc/>
    [UnconditionalSuppressMessage("Trimming", "IL2026", Justification = "An IQueryProvider member; every LadybugQueryable is created through LadybugConnection.Nodes<T>/Match<T>, which carry the trimming and AOT requirements.")]
    [UnconditionalSuppressMessage("Trimming", "IL2060", Justification = "See IL2026 on this member.")]
    [UnconditionalSuppressMessage("Trimming", "IL2070", Justification = "See IL2026 on this member.")]
...
internal static class Materializer
{
    ...
    private static MethodInfo? _graphValueReaderMethod;
    ...
    {
        _graphValueReaderMethod ??= typeof(Materializer).GetMethod(nameof(GraphValueReader), BindingFlags.Static | BindingFlags.NonPublic)!;
        var typed = (Delegate)_graphValueReaderMethod.MakeGenericMethod(clrType).Invoke(null, [clrType, properties])!;
